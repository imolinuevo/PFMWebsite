            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-sm-6">
                        ...
                        <h2 class="section-heading">Start using your own personal storage safely</h2>
                        <p class="lead">Your uploaded files will be encrypted and kept in your server for your security and privacy. You only need a hosting server with Apache, MySQL and PHP.</p>
                    </div>
